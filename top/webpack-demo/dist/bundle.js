              ...
              vr = (function n(t) {
                ...
                function Me(n, t) {
                  return di(n) && mi(t)
                    ...
                    : function (r) {
                        var e = kf(r, n);
                        return e === u && e === t ? Of(r, n) : Re(t, e, 3);
                      };
                }
                ...
                function gu(n, t) {
                  return Po(n) ? n : di(n, t) ? [n] : Ti(yf(n));
                }
                var du = Ke;
                function yu(n, t, r) {
                  var e = n.length;
                ...
                function Lu(n) {
                  return function (t) {
                    return Tt(Yf(Pf(t).replace(Yn, "")), n, "");
                  };
                }
                function Tu(n) {
                  return function () {
                ...
                function Vu(n, t, r, o, l, s, h, p) {
                  ...
                  return Si((y ? Ye : ki)(w, b), n, t);
                }
                function Gu(n, t, r, e) {
                  return n === u || (Do(n, zn[r]) && !Tn.call(e, r)) ? t : n;
                }
                ...
                var $o = Pu(Ae),
                  ...
                  Fo = Se(
                    ...
                    : function (n) {
                        return (
                          nf(n) && Tn.call(n, "callee") && !Kn.call(n, "callee")
                        );
                      },
                  Po = e.isArray,
                  qo = yt
                  ...
                  Af = Ke(function (n, t) {
                    ...
                    for (i && gi(t[0], t[1], i) && (e = 1); ++r < e; )
                      for (
                        ...
                        var l = f[a],
                          s = n[l];
                        (s === u || (Do(s, zn[l]) && !Tn.call(n, l))) &&
                          (n[l] = o[l]);
                      }
                    return n;
                  }),
                  If = Ke(function (n) {
                    return n.push(u, Ju), At(Tf, u, n);
                  });
                function kf(n, t, r) {
                ...
                return (
                  ...
                  (Mr.toPath = function (n) {
                    return Po(n) ? Ct(n, Wi) : af(n) ? [n] : ku(Ti(yf(n)));
                  }),
                  (Mr.toPlainObject = df),
                    ...
                    if ((f && (a += c.length - a), uf(i))) {
                      if (n.slice(a).search(i)) {
                        var l,
                          s = c;
                        for (
                          i.global || (i = kn(i.source, yf(pn.exec(i)) + "g")),
                            i.lastIndex = 0;
                          (l = i.exec(s));
        ...
        document.body.appendChild(
          (function () {
            ...
            return (
              ...
              (n.textContent = "Hi! My name is " + "Samuel"),
